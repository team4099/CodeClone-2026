...
object IndexerIOSim : IndexerIO {
  ...
  override fun updateInputs(inputs: IndexerIO.IndexerInputs) {
    ...
    inputs.floorBottomIndexerVelocity =
        floorBottomIndexerSim.angularVelocityRadPerSec.radians.perSecond
    ...
    inputs.sideRollerIndexerVelocity =
        sideRollerIndexerSim.angularVelocityRadPerSec.radians.perSecond
    ...
    inputs.bottomBeltIndexerVelocity =
        beltBottomIndexerSim.angularVelocityRadPerSec.radians.perSecond
