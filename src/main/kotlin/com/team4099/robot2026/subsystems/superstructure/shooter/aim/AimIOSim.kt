...
object AimIOSim : AimIO {
  private val aimSim: FlywheelSim =
      FlywheelSim(
  ...
  override fun setVelocity(velocity: AngularVelocity) {
    var pidOutput =
        aimPIDController.calculate(aimSim.angularVelocityRadPerSec.radians.perSecond, velocity)
    if (pidOutput.inVolts.isNaN()) pidOutput = 0.volts
    val ffOutput =
        aimFFController.calculateWithVelocities(
            aimSim.angularVelocityRadPerSec.radians.perSecond, velocity)
