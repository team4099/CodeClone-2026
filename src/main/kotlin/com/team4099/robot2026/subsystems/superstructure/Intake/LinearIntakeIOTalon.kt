...
object LinearIntakeIOTalon : LinearIntakeIO {
  ...
  init {
    ...
    configs.CurrentLimits.SupplyCurrentLimit = IntakeConstants.LinearIntakeConstants.CURRENT_LIMIT.inAmperes
    configs.CurrentLimits.StatorCurrentLimit = IntakeConstants.LinearIntakeConstants.CURRENT_LIMIT.inAmperes
  ...
  override fun setVoltage(targetVoltage: ElectricalPotential) {
    ...
    LintakeTalon.setControl(voltageOut.withOutput(clampedVoltage.inVolts))
  }
