...
object IntakeRollersIOTalon : IntakeRollersIO{
  ...
  init {
    ...
    rollerConfig.CurrentLimits.SupplyCurrentLimit = IntakeConstants.RollerIntakeConstants.SUPPLY_CURRENT_LIMIT.inAmperes
    rollerConfig.CurrentLimits.StatorCurrentLimit = IntakeConstants.RollerIntakeConstants.STATOR_CURRENT_LIMIT.inAmperes
  ...
  override fun updateInputs(inputs: IntakeRollersIO.RollerInputs) {
    ...
    inputs.rollerAcceleration =
      motorAcceleration.valueAsDouble.rotations.perSecond.perSecond * IntakeConstants.RollerIntakeConstants.GEAR_RATIO
  }

  override fun setVoltage(voltage: ElectricalPotential) {
    val clampedVoltage =
      clamp(
        voltage, -IntakeConstants.RollerIntakeConstants.VOLTAGE_COMPENSATION,
        IntakeConstants.RollerIntakeConstants.VOLTAGE_COMPENSATION)
