...
object IndexerIOTalon : IndexerIO {
  ...
  private val feedWheelsIndexerSensor =
      ctreAngularMechanismSensor(
          feedWheelsTalon, IndexerConstants.GEAR_RATIO, IndexerConstants.VOLTAGE_COMPENSATION)
  ...
  override fun setVelocity(velocity: AngularVelocity) {
    ...
    floorTalon.setControl(
        velocityControl
            ...
            .withAcceleration(
                floorIndexerSensor.accelerationToRawUnits(IndexerConstants.MAX_ACCELERATION)))
    feedWheelsTalon.setControl(
        velocityControl
            .withVelocity(feedWheelsIndexerSensor.velocityToRawUnits(velocity))
            .withAcceleration(
                feedWheelsIndexerSensor.accelerationToRawUnits(IndexerConstants.MAX_ACCELERATION)))
    sideRollerTalon.setControl(
        velocityControl
            .withVelocity(sideRollerIndexerSensor.velocityToRawUnits(velocity))
            .withAcceleration(
                sideRollerIndexerSensor.accelerationToRawUnits(IndexerConstants.MAX_ACCELERATION)))
    topBeltTalon.setControl(
        velocityControl
            .withVelocity(topBeltIndexerSensor.velocityToRawUnits(velocity))
            .withAcceleration(
                topBeltIndexerSensor.accelerationToRawUnits(IndexerConstants.MAX_ACCELERATION)))
    bottomBeltTalon.setControl(
        velocityControl
            .withVelocity(bottomBeltIndexerSensor.velocityToRawUnits(velocity))
            .withAcceleration(
                bottomBeltIndexerSensor.accelerationToRawUnits(IndexerConstants.MAX_ACCELERATION)))
  }
}
