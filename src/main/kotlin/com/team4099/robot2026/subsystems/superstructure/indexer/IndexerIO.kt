...
interface IndexerIO {
    class IndexerInputs : LoggableInputs {
        ...
        override fun toLog(table: LogTable) {
            ...
            table.put("floorIndexerAccelerationRPMPM", floorIndexerAcceleration.inRotationsPerMinutePerMinute)
            ...
            table.put("feedWheelsIndexerAccelerationRPMPM", feedWheelsIndexerAcceleration.inRotationsPerMinutePerMinute)
        ...
        override fun fromLog(table: LogTable) {
            ...
            table.get("floorIndexerAccelerationRPMPM", floorIndexerAcceleration.inRotationsPerMinutePerMinute).let {
                floorIndexerAcceleration = it.rotations.perMinute.perMinute
            }
            ...
            table.get("feedWheelsIndexerVelocityRPM", feedWheelsIndexerVelocity.inRotationsPerMinute).let {
                feedWheelsIndexerVelocity = it.rotations.perMinute
            }
            table.get("feedWheelsIndexerAccelerationRPMPM", feedWheelsIndexerAcceleration.inRotationsPerMinutePerMinute).let {
                feedWheelsIndexerAcceleration = it.rotations.perMinute.perMinute
            }
            table.get("feedWheelsIndexerSupplyCurrentAmps", feedWheelsIndexerSupplyCurrent.inAmperes).let {
                feedWheelsIndexerSupplyCurrent = it.amps
            }
            table.get("feedWheelsIndexerStatorCurrentAmps", feedWheelsIndexerStatorCurrent.inAmperes).let {
                feedWheelsIndexerStatorCurrent = it.amps
            }
            table.get("feedWheelsIndexerTorqueCurrentAmps", feedWheelsIndexerTorqueCurrent.inAmperes).let {
                feedWheelsIndexerTorqueCurrent = it.amps
            }
            table.get("feedWheelsIndexerAppliedVoltageVolts", feedWheelsIndexerAppliedVoltage.inVolts).let {
                feedWheelsIndexerAppliedVoltage = it.volts
            }
            ...
            table.get("sideRollerIndexerTorqueCurrentAmps", sideRollerIndexerTorqueCurrent.inAmperes).let {
                sideRollerIndexerTorqueCurrent = it.amps
            }
            ...
            table.get("bottomBeltIndexerTorqueCurrentAmps", bottomBeltIndexerTorqueCurrent.inAmperes).let {
                bottomBeltIndexerTorqueCurrent = it.amps
            }
