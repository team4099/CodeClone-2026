...
interface FlywheelIO {
    class FlywheelInputs : LoggableInputs {
        ...
        override fun toLog(table: LogTable) {
            ...
            table.put("FlywheelLeaderAccelerationRPMPM", flywheelLeaderAcceleration.inRotationsPerMinutePerMinute)
            ...
            table.put("FlywheelFollowerAccelerationRPMPM", flywheelFollowerAcceleration.inRotationsPerMinutePerMinute)
        }
