...
object IndexerConstants {
    ...
    object PID {
        ...
        val REAL_KI: IntegralGain<Velocity<Radian>, Ampere> = 0.0.amps / (0.0.radians.perSecond * 0.0.seconds)
        val REAL_KD: DerivativeGain<Velocity<Radian>, Ampere> = 0.0.amps / (0.0.radians.perSecond / 0.0.seconds)
        ...
        val REAL_KA: AccelerationFeedforward<Radian, Ampere> = 0.0.amps / 0.0.radians.perSecond.perSecond

        val SIM_KP: ProportionalGain<Velocity<Radian>, Volt> = 0.0.volts / 0.0.degrees.perSecond
        val SIM_KI: IntegralGain<Velocity<Radian>, Volt> = 0.0.volts / (0.0.rotations.perMinute * 0.0.seconds)
        val SIM_KD: DerivativeGain<Velocity<Radian>, Volt> = 0.0.volts / (0.0.rotations.perMinute.perSecond)
